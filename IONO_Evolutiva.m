function Feat_Index =  IONO_Evolutiva
clear all
global Data 
clear
clc
...
load IONO.data
Data  = load('IONO.data'); % Se carga el dataset
LargoString =34; % Número de características en el dataset
...
ParametrosGA = gaoptimset('CreationFcn', {@PopFunction},...
                     ...
                     'Display', 'iter'); 
rand('seed',1)
nVars = 34; % Cantidad de variables independientes
...
function [FitVal] = FitFunc_SVM(pop)
    ...
    columnasSeleccionadas=IONO(1:end,ind);
    clasificaciones=IONO(1:end,35);
