function Feat_Index =  GC_Evolutiva
clear all
global Data 
clear
clc
...
load GC.data
Data  = load('GC.data'); % Se carga el dataset
LargoString =24; % Número de características en el dataset
...
ParametrosGA = gaoptimset('CreationFcn', {@PopFunction},...
                     ...
                     'Display', 'iter'); 
rand('seed',1)
nVars = 24; % Cantidad de variables independientes
...
function [FitVal] = FitFunc_SVM(pop)
    ...
    columnasSeleccionadas=GC(1:end,ind);
